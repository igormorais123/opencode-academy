// Conteudo dos modulos do curso
// OpenCode Academy - Prof. Igor Morais Vasconcelos - INTEIA

export interface Step {
  id: string
  type: 'text' | 'code' | 'tip' | 'warning' | 'theory' | 'image' | 'checker' | 'quiz'
  content: string
  codeContent?: string
  options?: { label: string; correct?: boolean }[]
  osSpecific?: 'windows' | 'mac' | 'both'
}
        ...
        steps: [
          {
            id: "0.1.1",
            type: "text",
            content: "Pense na sua semana de trabalho...\n\nQuantas horas voce gasta em tarefas repetitivas?\n\n• Organizar arquivos em pastas\n• Procurar documentos perdidos\n• Formatar textos e relatorios\n• Revisar contratos longos\n• Criar apresentacoes\n• Responder e-mails similares"
          },
          {
            id: "0.1.2",
            type: "tip",
            content: "Profissionais gastam em media 4,5 horas por semana em tarefas que poderiam ser automatizadas. Isso sao 234 horas por ano. Quase 10 dias!"
          },
          {
            id: "0.1.3",
            type: "checker",
            content: "Voce se identificou com isso?"
          }
        ]
      },
      {
        ...
        steps: [
          {
            ...
            type: "text",
            osSpecific: "windows",
            content: "OS UNICOS 5 COMANDOS QUE VOCE PRECISA SABER:\n\n🪟 PARA WINDOWS:\n\ncd          → Muda de pasta\ncd ..       → Volta uma pasta\ndir         → Lista arquivos\ncls         → Limpa a tela\nopencode    → Abre o OpenCode"
          },
          {
            id: "1.3.1",
            type: "text",
        ...
        steps: [
          {
            id: "2.1.1",
            type: "text",
            content: "WezTerm e um programa de terminal.\n\nLembra que o terminal e uma forma de conversar com o computador por texto?\n\nO WezTerm e o PROGRAMA onde essa conversa acontece.\nE como o WhatsApp e o programa onde voce conversa com outras pessoas."
          },
          {
            id: "2.1.2",
            type: "text",
            osSpecific: "windows",
            content: "O Windows tem um terminal proprio, mas o WezTerm e melhor porque funciona perfeitamente com o OpenCode."
          },
          {
            id: "2.1.2",
            type: "text",
            osSpecific: "mac",
            content: "O Mac tem um terminal proprio chamado Terminal, mas o WezTerm e melhor porque funciona perfeitamente com o OpenCode."
          }
        ]
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            type: "tip",
            osSpecific: "windows",
            content: "\".exe\" significa que e um programa executavel para Windows.\nE isso que voce precisa baixar."
          },
          {
            id: "2.2.9",
            type: "checker",
            content: "Clicou e o download comecou?"
          }
        ]
      },
      {
        ...
        steps: [
          {
            id: "2.3.1",
            type: "text",
            content: "Aguarde o download terminar.\nNormalmente leva menos de 1 minuto."
          },
          {
            id: "2.3.2",
            type: "text",
        ...
        steps: [
          {
            id: "3.5.1",
            type: "text",
            content: "Agora vamos verificar se o Node.js foi instalado corretamente.\n\n1. Abra o WezTerm\n\n2. Digite o comando abaixo e pressione ENTER:"
          },
          {
            id: "3.5.2",
            type: "code",
    ...
    lessons: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            type: "text",
            osSpecific: "windows",
            content: "Agora copie e cole este comando INTEIRO no terminal:"
          },
          {
            id: "4.1.3",
            type: "text",
            osSpecific: "mac",
            content: "Abra o WezTerm e copie e cole este comando:"
          },
          {
            id: "4.1.4",
            type: "code",
            osSpecific: "windows",
            content: "Copie este comando (e grande, copie TUDO):",
            codeContent: "Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://community.chocolatey.org/install.ps1'))"
          },
          {
            id: "4.1.4",
            type: "code",
            osSpecific: "mac",
            content: "Copie este comando:",
            codeContent: "/bin/bash -c \"$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)\""
          },
          {
            id: "4.1.5",
            type: "warning",
          ...
          },
          {
            id: "4.1.6",
            type: "text",
            content: "Depois de colar, pressione ENTER e aguarde.\nPode demorar 2-3 minutos."
          },
          {
            id: "4.1.7",
            type: "text",
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            osSpecific: "windows",
            content: "Digite:",
            codeContent: "choco install opencode"
          },
          {
            id: "4.2.2",
            type: "code",
            osSpecific: "mac",
            content: "Digite:",
            codeContent: "brew install anomalyco/tap/opencode"
          },
          {
            id: "4.2.3",
            type: "text",
          ...
          },
          {
            ...
            type: "text",
            osSpecific: "windows",
            content: "Quando perguntar:\n\"Do you want to run the script?\"\n\nDigite Y (a letra Y) e pressione ENTER."
          },
          {
            id: "4.2.5",
            type: "text",
            content: "Aguarde terminar.\nPode levar 1-2 minutos."
          },
          {
            id: "4.2.6",
            type: "checker",
        ...
        steps: [
          {
            id: "4.3.1",
            type: "text",
            content: "Agora vamos verificar se o OpenCode foi instalado.\n\n1. FECHE o WezTerm completamente\n\n2. Abra novamente (nao precisa ser como administrador desta vez)\n\n3. Digite:"
          },
          {
            id: "4.3.2",
            type: "code",
            content: "Digite:",
            codeContent: "opencode --version"
          },
          {
            id: "4.3.3",
            type: "text",
            content: "Deve aparecer um numero de versao, como:\n\n1.1.27\n\n(O numero pode ser diferente)"
          },
          {
            id: "4.3.4",
            type: "tip",
          ...
          },
          {
            id: "4.3.5",
            type: "checker",
            content: "Apareceu o numero da versao?"
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        steps: [
          ...
          },
          {
            id: "5.1.3",
            type: "checker",
            content: "Criou a pasta MeuOpenCode?"
          }
        ]
      },
      {
        ...
        steps: [
          {
            id: "5.2.1",
            type: "text",
            content: "Agora vamos abrir o OpenCode dentro da sua pasta.\n\n1. Abra o WezTerm"
          },
          {
            id: "5.2.2",
            type: "text",
            osSpecific: "windows",
            content: "2. Digite este comando para ir ate sua pasta:\n\n(Substitua \"SeuNome\" pelo seu nome de usuario do Windows)"
          },
          {
            id: "5.2.2",
            type: "text",
          ...
          },
          {
            ...
            type: "code",
            osSpecific: "windows",
            content: "Digite (troque SeuNome pelo seu usuario):",
            codeContent: "cd C:\\Users\\SeuNome\\Documents\\MeuOpenCode"
          },
          {
            id: "5.2.3",
            type: "code",
            osSpecific: "mac",
            content: "Digite:",
            codeContent: "cd ~/Documents/MeuOpenCode"
          },
          {
            id: "5.2.4",
            type: "tip",
            osSpecific: "windows",
            content: "NAO SABE SEU NOME DE USUARIO?\n\nDigite apenas: cd\nVai mostrar algo como: C:\\Users\\Joao\nUse esse nome no comando."
          },
          {
            id: "5.2.5",
            type: "text",
            content: "3. Pressione ENTER\n\n4. Agora digite:"
          },
          {
            id: "5.2.6",
            type: "code",
            content: "Digite:",
            codeContent: "opencode"
          },
          {
            id: "5.2.7",
            type: "text",
            content: "5. Pressione ENTER\n\nUma interface vai aparecer dentro do terminal!"
          },
          {
            id: "5.2.8",
            type: "checker",
            content: "O OpenCode abriu?"
          }
        ]
      },
      {
        ...
        steps: [
          ...
          },
          {
            id: "5.3.7",
            type: "checker",
            content: "Conseguiu copiar a chave do Google?"
          }
        ]
      },
      {
        ...
        steps: [
          {
            id: "5.4.1",
            type: "text",
            content: "Agora vamos conectar a chave no OpenCode.\n\n1. Com o OpenCode aberto, pressione:"
          },
          {
            id: "5.4.2",
            type: "code",
            osSpecific: "windows",
            content: "Pressione estas teclas:",
            codeContent: "CTRL + P"
          },
          {
            id: "5.4.2",
          ...
          },
          {
            id: "5.4.5",
            type: "text",
            content: "8. Pressione ENTER"
          },
          {
            id: "5.4.6",
            type: "checker",
            content: "Conseguiu conectar?"
          }
        ]
      },
      {
        ...
        steps: [
          {
            id: "5.5.1",
            type: "text",
            content: "Vamos testar se esta funcionando!\n\nNo OpenCode, digite uma pergunta simples:"
          },
          {
            id: "5.5.2",
            type: "code",
            content: "Digite:",
            codeContent: "Ola! Quem e voce?"
          },
          {
            id: "5.5.3",
            type: "text",
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            type: "code",
            content: "Digite:",
            codeContent: "Liste 5 formas que voce pode me ajudar no trabalho de escritorio"
          },
          {
            id: "6.4.3",
            type: "text",
          ...
          },
          {
            id: "6.4.4",
            type: "checker",
            content: "A IA listou as 5 formas?"
          }
        ]
      }
    ]
...
// Funcao para filtrar steps por OS
export function filterStepsByOs(steps: Step[], userOs: 'windows' | 'mac'): Step[] {
